 ...
 */
public class TestRandomQueueMain {
	...
	public static void main(String args[])
	{
		...
		for (int i = 0; i < 100000; ++i) {
			rqRolls[i] = RQ.sample(); // autounboxing! Also cool!
		...
		TestRandomQueueIterator();
		TestRandomQueueArrayIterator();
		TestRandomQueueDequeue();
		TestRandomQueueArrayDequeue();
		TestSamplingRandomQueue();
		TestSamplingRandomQueueArray();
		
	}


	
	public static void TestRandomQueueIterator() {
	...
	public static void TestRandomQueueArrayIterator() {
	...
	public static void TestRandomQueueDequeue() {
		int size = 10;
	...
	public static void TestRandomQueueArrayDequeue() {
		int size = 10;
	...
	public static void TestSamplingRandomQueue() {
	...
	public static void TestSamplingRandomQueueArray() {
